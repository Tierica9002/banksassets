                ...
                <div class="col-lg-12 col-md-12 ">
                    ...
                    <div class="panel panel-transparent">
                        <div class="panel-body">
                            {{ Form::open(['route' => ['administrator.villa.store'],'method' => 'post', 'role' => 'form', 'autocomplete' => 'off', 'id' => 'add-villa']) }}
                            ...
                            <div class="panel panel-default">
                             ...
                             <button class="btn btn-primary" id="add-villa-submit">Add Villa</button>
                        </div>
                    </div>
                    <div class="clearfix"></div>
                    <!-- END PANEL -->
