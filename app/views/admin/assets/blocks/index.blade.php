            ...
            <div class="container-fluid container-fixed-lg sm-p-l-20 sm-p-r-20">
                <div class="inner">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li><a href="#" class="active">List Blocks</a>
                        </li>
                    </ul>
                    <!-- END BREADCRUMB -->                
                </div>
        ...
        <div class="container-fluid container-fixed-lg bg-white">
            ...
            <div class="panel panel-transparent">
                ...
                <div class="panel-body">                                        
                    <a href="{{ URL::route('administrator.block.create') }}" class="btn btn-default btn-cons m-b-10"><i class="fa fa-plus-circle"></i> Add Block</a>                    
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="v-align-middle text-center">
                                    {{ Form::open(array('route' => array('administrator.block.destroy', $block->id), 'method' => 'delete')) }}
                                    <div class="btn-group btn-group-xs">
                                        <a href="{{ URL::route('administrator.block.edit', ['id'=> $block->id]) }}" type="button" class="btn btn-default"><i class="fa fa-pencil"></i> Edit</a>                                        
