            ...
            <div class="container-fluid container-fixed-lg sm-p-l-20 sm-p-r-20">
                <div class="inner">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li><a href="#" class="active">List Types</a>
                        </li>
                    </ul>
                    <!-- END BREADCRUMB -->                
                </div>
        ...
        <div class="container-fluid container-fixed-lg bg-white">
            ...
            <div class="panel panel-transparent">
                ...
                <div class="panel-body">                                        
                    <a href="{{ URL::route('administrator.type.create') }}" class="btn btn-default btn-cons m-b-10"><i class="fa fa-plus-circle"></i> Add Type</a>                    
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="v-align-middle text-center">
                                    {{ Form::open(array('route' => array('administrator.type.destroy', $type->id), 'method' => 'delete')) }}
                                    <div class="btn-group btn-group-xs">
                                        <a href="{{ URL::route('administrator.type.edit', ['id'=> $type->id]) }}" type="button" class="btn btn-default"><i class="fa fa-pencil"></i> Edit</a>                                                                                
