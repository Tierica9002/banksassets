            ...
            <div class="col-md-9 col-sm-9">
                <section id="agent-detail">
                    ...
                    <section id="form">
                        ...
                        {{ Form::open(['route' => 'main.sendmessage','method' => 'post', 'class' => 'clearfix', 'id' => 'form-contanct', 'role' => 'form']) }}
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="form-contact-name">Your Name<em>*</em></label>
                                    <input type="text" class="form-control" id="form-contact-name" name="user_name" required>
                                </div><!-- /.form-group -->
                            </div><!-- /.col-md-6 -->
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="form-contact-email">Your Email<em>*</em></label>
                                    <input type="email" class="form-control" id="form-contact-email" name="user_email" required>
                                </div><!-- /.form-group -->
                            </div><!-- /.col-md-6 -->
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="form-contact-email">Your phone</label>
                                    <input type="text" class="form-control" id="form-contact-email" name="user_phone">
                                </div><!-- /.form-group -->
                            </div><!-- /.col-md-6 -->
                        </div><!-- /.row -->
                        <div class="row">
