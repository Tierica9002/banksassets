    ...
    <div class="page-sidebar" data-pages="sidebar">
      <div id="appMenu" class="sidebar-overlay-slide from-top">
        ...
        <div class="sidebar-header">
            <img src="{{asset('admin/img/logo_white.png')}}" alt="logo" class="brand" data-src="{{asset('admin/img/logo_white.png')}}" data-src-retina="{{asset('admin/img/logo_white_2x.png')}}" width="93" height="25">
