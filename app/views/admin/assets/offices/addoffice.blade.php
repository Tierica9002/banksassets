    ...
    <div class="content">
        ...
        <div class="container-fluid container-fixed-lg">
            ...
            <ul class="breadcrumb">
                ...
                <li><a href="#" class="active">Add Office</a>
                </li>
            </ul>
            <!-- END BREADCRUMB -->
            <div class="row">
                <div class="col-lg-12 col-md-12 ">
                    ...
                    <div class="panel panel-transparent">
                        <div class="panel-body">
                            {{ Form::open(['route' => ['administrator.office.store'],'method' => 'post', 'role' => 'form', 'autocomplete' => 'off', 'id' => 'add-office']) }}
                            ...
                            <div class="panel panel-default">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group form-group-default">
                                            ...
                                            {{Form::select('categorii_clasificare', array('Cladiri de birouri verzi' => 'Cladiri de birouri verzi', 'Birouri de clasa A' => 'Birouri de clasa A',
                                                        ...
                                                        'Birouri in apartamente, vile' => 'Birouri in apartamente, vile', 'Birouri instant' => 'Birouri Instant', 'Cladiri  de birouri vanzare' => 'Cladiri de birouri vanzare'), null, ['class' => 'full-width', 'data-init-plugin' => 'select2']);}}                                           
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="form-group form-group-default">
                                            ...
                                            {{Form::select('statutul_cladirii', array('Existenta' => 'Existenta', 'In Constructie' => 'In Constructie',
                                                        'Planificata' => 'Planificata'), null, ['class' => 'full-width', 'data-init-plugin' => 'select2']);}}                                           
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="form-group form-group-default">
                                            <label>Suprafata Totala Birouri</label>
                                            {{Form::text('suprafata_totala_birouri', null, ['class' => 'form-control'])}}
                                        </div>
                                    </div>     
                                    <div class="col-sm-6">
                                        <div class="form-group form-group-default">
                                            <label>Birou disponibil</label>
                                            {{Form::text('birou_disponibil', null, ['class' => 'form-control'])}}
                                        </div>
                                    </div>                                           
                                </div>
                                <div class="panel-heading">
                                ...
                                <div class="panel-body" id="floors">                                    
                                    ...
                                    <div class="col-sm-5">
                                        <div class="form-group form-group-default">
                                            {{Form::text('surface[]', null, ['class' => 'form-control', 'placeholder' => 'Suprafata'])}}                                                                                 
                                        </div>
                                    </div>
                                    <div class="col-sm-5">
                                        <div class="form-group form-group-default">
                                            {{Form::text('rent_cost[]', null, ['class' => 'form-control', 'placeholder' => 'Cost Chirie'])}}
                                        </div>
                                    </div>                                                
                                ...
                                <div class="panel-body">
                                    <div class="col-sm-3">
                                        <div class="form-group form-group-default">
                                            ...
                                            {{Form::text('birouri_min_inchiriat', null, ['class' => 'form-control'])}}
                                        </div>
                                    </div>     
                                    <div class="col-sm-3">
                                        <div class="form-group form-group-default">
                                            <label>Rata de Ocupare</label>
                                            {{Form::text('rata_ocupare', null, ['class' => 'form-control'])}}
                                        </div>
                                    </div>     
                                    <div class="col-sm-3">
                                        <div class="form-group form-group-default">
                                            <label>Cost Inchiriere Birouri</label>
                                            {{Form::text('cost_inchiriere_birouri', null, ['class' => 'form-control'])}}
                                        </div>
                                    </div>     
                                    <div class="col-sm-3">
                                        <div class="form-group form-group-default">
                                            <label>Pret Vanzare</label>
                                            {{Form::text('pret_vanzare', null, ['class' => 'form-control'])}}
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="panel-body">
                                    <div class="col-sm-6">
                                        <div class="form-group form-group-default">
                                            ...
                                            {{Form::select('tip_parcare', array('Supraterana' => 'Supraterana', 'Parcare subterana' => 'Parcare subterana'), null, ['class' => 'full-width', 'data-init-plugin' => 'select2']);}}
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="form-group form-group-default">
                                            <label>Cost parcare</label>
                                            {{Form::text('cost_parcare', null, ['class' => 'form-control'])}}
                                        </div>
                                    </div>     
                                </div>
                            </div>                            
                                ...
                                <div class="panel-body">
                                    <div class="checkbox ">
                                        <h5>Detalii Tehnice</h5>
                                          {{Form::checkbox('control_access',1,null, ['id' => 'checkbox8'])}}
                                            <label for="checkbox8">Control Acces</label>                                            
                                            {{Form::checkbox('sistem_antiincendiu',1,null, ['id' => 'checkbox9'])}}
                                            <label for="checkbox9">Sistem Antiincendiu</label>                                            
                                            {{Form::checkbox('detectoare_fum_incendiu',1,null, ['id' => 'checkbox10'])}}
                                            <label for="checkbox10">Detectoare de fum/incendiu</label>                                            
                                            {{Form::checkbox('tavan_fals',1,null, ['id' => 'checkbox11'])}}
                                            <label for="checkbox11">Tavan Fals</label>                                            
                                            {{Form::checkbox('hvac',1,null, ['id' => 'checkbox12'])}}
                                            <label for="checkbox12">HVAC</label>                                            
                                            {{Form::checkbox('ventiloconvectoare_2_tevi',1,null, ['id' => 'checkbox13'])}}
                                            <label for="checkbox13">Ventiloconvectoare cu 2 tevi</label>                                            
                                            {{Form::checkbox('incalzire_centrala',1,null, ['id' => 'checkbox14'])}}  
                                            <label for="checkbox14">Incalzire Centrala</label>                       
                                    </div>
                                    <div class="checkbox ">
                                        <h5>Contoare</h5>
                                            {{Form::checkbox('contoare',1,null, ['id' => 'checkbox15'])}}
                                            <label for="checkbox15">Contoare</label>                                            
                                    </div>
                                    <div class="checkbox ">
                                        <h5>Ferestre</h5>
                                            {{Form::checkbox('geamuri_termopan',1,null, ['id' => 'checkbox16'])}}
                                            <label for="checkbox16">Geamuri Termopan</label>                                            
                                    </div>
                                    <div class="checkbox ">
                                        <h5>Servicii Asigurate In Cladire</h5>
                                            {{Form::checkbox('curatarea_ferestrelor_exterioare',1,null, ['id' => 'checkbox17'])}}
                                            <label for="checkbox17">Paza Permanenta</label>                                            
                                            {{Form::checkbox('paza_permanenta',1,null, ['id' => 'checkbox18'])}}
                                            <label for="checkbox18">Paza Permanenta</label>                                            
                                            {{Form::checkbox('intrenetinere_reparatii_lifturi',1,null, ['id' => 'checkbox19'])}}
                                            <label for="checkbox19">Intretinere Reparatii Lifturi</label>                                            
                                            {{Form::checkbox('administratie_management_proprietate',1,null, ['id' => 'checkbox20'])}}
                            ...
                            <button class="btn btn-primary" id="add-office-submit">Add Office</button>
                        </div>
                    </div>
                    <div class="clearfix"></div>
                    <!-- END PANEL -->
