            ...
            <div class="container-fluid container-fixed-lg sm-p-l-20 sm-p-r-20">
                <div class="inner">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li><a href="#" class="active">List Offices</a>
                        </li>
                    </ul>
                    <!-- END BREADCRUMB -->                
                </div>
        ...
        <div class="container-fluid container-fixed-lg bg-white">
            ...
            <div class="panel panel-transparent">
                ...
                <div class="panel-body">                                        
                    <a href="{{ URL::route('administrator.office.create') }}" class="btn btn-default btn-cons m-b-10"><i class="fa fa-plus-circle"></i> Add Office</a>                    
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="v-align-middle">
                                    <p>{{$office->descriere}}</p>
                                </td>                                
                                <td class="v-align-middle text-center">
                                    {{ Form::open(array('route' => array('administrator.office.destroy', $office->id), 'method' => 'delete')) }}
                                    <div class="btn-group btn-group-xs">
                                        <a href="{{ URL::route('administrator.office.edit', ['id'=> $office->id]) }}" type="button" class="btn btn-default"><i class="fa fa-pencil"></i> Edit</a>                                        
